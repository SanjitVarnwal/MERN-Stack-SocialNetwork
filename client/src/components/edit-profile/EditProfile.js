        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <small className="d-block text-danger pb-3">
                * required field
              </small>
              <form onSubmit={this.onSubmit}>
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.handle}
                  info="A unique handle for your profile URl. Your full name, nick name "
                />
                <SelectListGroup
                  name="status"
                ...
                <TextFieldGroup
                  ...
                  info="Could be your own company or where do you work "
                />
                <TextFieldGroup
                  placeholder="Website"
                  name="website"
                  ...
                  info="Could be your website or blog "
                />
                <TextFieldGroup
                ...
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.skills}
                  info="Please use comma separated values eg - HTML,CSS,JS,Python"
                />
                <TextFieldGroup
                  ...
                  info="Include github username to show off your awesome Projects and repositories on github"
                />
                <TextAreaFieldGroup
